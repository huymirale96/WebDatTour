<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/BackEnd.Master" AutoEventWireup="true" CodeBehind="DoiMatKhau.aspx.cs" Inherits="WebDatTour.View.BackEnd.DoiMatKhau" %>
                         ...
                         <form class="form-horizontal" method="POST" runat="server">
                                <fieldset>
                                    ...
                                    <div class="col-md-12 text-center">
                                        <asp:Label ID="lblNoti" runat="server" Text="" CssClass="text-info"></asp:Label>
                                    </div>
